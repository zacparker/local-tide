  ...
  actionPerformed: function() {
    ...
    query.observeChanges({ // listen to changes to the collection
      ...
      added: function(id, fields) { // if anything is added to the collection
        if (fields.artist === "rosch") { // if the added item matches this artist
          ...
          $selectedImgContainer.html('<img src="/media/rosch/display/' + selectedImageNumber + '.jpg">'); // add the selected image to it's container
